    ...
    return (
      ...
      <section id="time-control">
                <div className="current-time">{this.props.currentTime}</div>
                 ...
                 />
                 <div className="total-time">{this.props.duration}</div>       </section>
      <section id="volume-control">
      <div className="current-time">{this.props.currentVolume}</div>
      <input
        type="range"
        className="seek-bar"
        value={(this.props.currentVolume / this.props.volume) || 0.5}
        max="1"
        min="0"
        step="0.01"
      />
